...
const HookHarness = forwardRef<UseStandardSchemaReturn<FormType> | null, HookHarnessProps<FormType>>(
...
const FormHarness = forwardRef<UseStandardSchemaReturn<FormType> | null, FormHarnessProps<FormType>>(
...
export function renderFormHarness({
	formDef = makeForm(),
	onSubmitSpy,
}: {
	formDef?: FormType
